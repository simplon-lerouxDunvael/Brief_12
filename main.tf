...
module "deployment" {
  source = "git::https://github.com/simplon-lerouxDunvael/Brief_12Ter" # https://github.com/simplon-lerouxDunvael/Brief_12Bis / https://github.com/simplon-lerouxDunvael/Brief_12Ter
